// src/components/gallery/SlideshowModal.jsx
import React, { useCallback, useEffect, useRef, useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { ArrowLeft, ArrowRight, Download, Pause, Play, X } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { toast } from '@/components/ui/use-toast';

const SlideshowModal = ({ event, uploads, startIndex, onClose, closeBtnRef }) => {
  ...
  useEffect(() => {
    ...
    if (isPlaying) slideshowInterval = setInterval(goToNext, 3000);
  ...
  }, [goToNext, goToPrev, onClose, closeBtnRef]);
