...
const PlannerButton = ({ label, desc, onClick }) => (
  <Button
    onClick={onClick}
    variant="outline"
    className="bg-violet-600 text-white hover:bg-violet-700 border-violet-600 justify-start p-4 h-auto text-left"
  >
    <div className="flex flex-col">
      <span>{label}</span>
      <span className="text-xs font-normal text-white/80">{desc}</span>
    </div>
  </Button>
);
